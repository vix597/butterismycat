...
class Comic(models.Model):
    ...
    show_title = models.BooleanField(
        ...
        help_text="If this is checked, the title of the comic will be displayed on the web page. "
                  "Uncheck to hide the title for this comic.")
    ...
    include_hover_text = models.BooleanField(
        ...
        help_text="If this is checked, the hover text will be displayed when the user hovers their "
                  "mouse over the comic. Uncheck to disable hover text for this comic.")
    ...
    show_description = models.BooleanField(
        ...
        help_text="If this is checked, the description will be accessible for this comic. Leave "
                  "this unchecked to keep the description private.")
    ...
    is_nsfw = models.BooleanField(
        verbose_name="Is Not Safe For Work?", default=False,
        help_text="If this is checked, the comic is NSFW and will be hidden by default. "
                  "The user will need to click to reveal the comic.")
